...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://jakubwaw93.github.io";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("username")).sendKeys("jakubwaw93@gmail.com");
        WebElement el = driverTrello.findElement(By.id("login-submit"));
        el.submit();

        Thread.sleep(2000);

        driverTrello.findElement(By.id("password")).sendKeys("Kubarozpruwacz93");
        el.submit();
